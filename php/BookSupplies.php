...
<div id="solo"style="width:55%; height: 80%;background-color:#FFC0CB; margin: auto; margin-top: 
 ...
 <div class="row">
     <div class="column middle" style="width:45%; height: 60%;background: rgb(0, 0, 0);background: rgba(255,209,220,0.7);color: #f1f1f1; margin-bottom: 2em;margin-top: 2em; margin-left: 4em; margin-right: 4em;"><a href="(Bk)ArtSupplies.php" style="text-decoration:transparent;"><h1 style="color:white;">Art Supplies<br>The best most durable mobile cases in town<br>Get yours now!</h3></a></div>
   </div>
 </div> 
...
<div class="row">
    <div class="column middle" style="width:45%; height: 60%;background: rgb(0, 0, 0);background: rgba(255,209,220,0.7);color: #f1f1f1;margin-bottom: 2em;margin-top: 2em; margin-left: 22em; margin-right: 2em;"><a href="(Bk)Literature.php" style="text-decoration:transparent;"><h2 style="color:white">Literature<br>The best most durable mobile cases in town<br>Get yours now!</h3></a></div>
  </div>
</div> 
...
<div id="solo"style="width:55%; height: 80%;;object-fit:scale-down;background-color:#FFC0CB; margin: auto; margin-top: 
 ...
 <div class="row">
     <div class="column middle" style="width:45%; height: 60%;background: rgb(0, 0, 0);background: rgba(255,209,220,0.7);color: #f1f1f1;margin-bottom: 2em;margin-top: 2em; margin-left: 4em; margin-right: 4em;"><a href="(Bk)Notepads.php" style="text-decoration:transparent;"><h2 style="color:white">Notepads<br>The best most durable mobile cases in town<br>Get yours now!</h3></a></div>
   </div>
 </div>  -->
 ...
 <div style="width:100%; height: 100%;background-color:rgb(255, 209, 220);margin-bottom:0.2em;"> 
               ...
               <div id="solo"style="width:55%; height: 80%;background-color:#FFC0CB;  margin: auto; margin-top: 
                0.2em;background-image:url('../assets/StyleAssets/art_lk.jpg');">
                <div class="row">
                    <div class="column middle" style="width:45%; height: 60%;background: rgb(0, 0, 0);background: rgba(255,209,220,0.7);color: #f1f1f1; margin-bottom: 2em;margin-top: 4em; margin-left: 4em; margin-right: 4em;"><a href="(Bk)ArtSupplies.php" style="text-decoration:transparent;font-family:Arial;"><h1 style="color:#701a2e; font-size: 3em;margin-left:0.5em;margin-top:1em;margin-bottom:1em;"><b>Art Supplies</b><br></h1></a></div>
                  </div>
                </div> 
               ...
               <div id="solo"style="width:55%; height: 80%;background-color:#FFC0CB; margin: auto; margin-top: 
               2em;background-image: url('../assets/StyleAssets/bk_lk.jpg');">
               <div class="row">
                   <div class="column middle" style="width:45%; height: 60%;background: rgb(0, 0, 0);background: rgba(255,209,220,0.7);color: #f1f1f1;margin-bottom: 2em;margin-top: 4em; margin-left: 22em; margin-right: 5em;"><a href="(Bk)Literature.php" style="text-decoration:transparent;font-family:Arial;"><h1 style="color:#701a2e;font-size: 3em;margin-left:0.5em;margin-top:1em;margin-bottom:1em;"><b>Literature Books</b><br></h1></a></div>
                 </div>
               </div> 

               <div id="solo"style="width:55%; height: 80%;;object-fit:scale-down;background-color:#FFC0CB; margin: auto; margin-top: 
                2em;background-image: url('../assets/StyleAssets/np_lk.jpg');">
                <div class="row">
                    <div class="column middle" style="width:45%; height: 60%;background: rgb(0, 0, 0);background: rgba(255,209,220,0.7);color: #f1f1f1;margin-bottom:0.2em;margin-top: 8em; margin-left: 4em; margin-right: 4em;"><a href="(Bk)Notepads.php" style="text-decoration:transparent;font-family:Arial;"><h1 style="color:#701a2e; font-size: 3.7em;margin-left:0.5em;margin-top:1em;margin-bottom:1em;"><b>Notepads</b><br></h1></a></div>
                  </div>
                </div> 
    ...
    <!-- <div class="container1">
        <div class="item1">
            <img src = "../assets/bts stickers.jpg" class="centre">
            <h3>BTS Stickers</h3>
            <a href="bts(stickers).php"><button type="submit">VISIT</button></a>
        </div>
        <div class="item1">
            <img src ="../assets/bts accessories.jpg" class="centre">
            <h3>BTS Accessories</h3>
            <a href="bts(accessories).php"><button type="submit">VISIT</button></a>
            
        </div>  <div class="item1">
            <img src = "../assets/bts clothes.jpg" class="centre">
            <h3>BTS Clothes</h3>
            <a href="bts(clothing).php"><button type="submit">VISIT</button></a>
        </div>            
